...
int MDNS::processQueries() {
	...
	//        udp->stop();
	    ...
	    debug << "mDNS Query [" << flags << "][" << qdcount << "]\r\n";
			...
			debug << "mDNS [" << matcher->getLastName() << "][" << cls << "][" << matchedName << "]\r\n";
	    ...
	    debug << "mDNS Response [" << counts << "][" << responses << "]\r\n";
...
void MDNS::writeARecord() {
    ...
    IPAddress ip = connection.getLocalIPAddress();
