  ...
  <xsl:template name="grading">
	...
	<g transform="scale({$scale})">
	  ...
	  <path
	      ...
	      style="fill:none;stroke:#030303;stroke-width:{0.265 div $scale}" />
	  <path style="fill:none;stroke:#030303;stroke-width:{0.265 div $scale}"
		d="m -2.440413,-9.0485165 0.216323,0.810001" />
	  <path style="fill:none;stroke:#030303;stroke-width:{0.353 div $scale}" 
